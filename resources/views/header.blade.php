        ...
        <div>
            @if(Auth::guard('web')->check() && Auth::guard('web')->user())
                ...
                <div class="relative px-2 py-1.5 border rounded-[8px] cursor-pointer text-xs mr-4" id="user">
                    ...
                    <div class="absolute bg-white shadow-sm border px-2 py-2 w-[160px] rounded-[8px] flex flex-col transition-all duration-100 ease-in left-[30%] top-[115%] opacity-0" id="user-item">
