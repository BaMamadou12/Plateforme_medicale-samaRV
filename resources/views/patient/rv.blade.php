...
@section('section')
    <section class="w-8/12 mx-auto mb-10">
        ...
        <div>
            ...
            <h1
                class="text-2xl font-bold font-kanit italic tracking-wide  mt-12 border-l-8 border-green-600
            ...
            <div class="w-full p-8 bg-white rounded-2xl mb-4 shadow-md">
                ...
                <form action="{{ route('rv_today', compact('id_medecin')) }}" method="post">
                    ...
                    <button type="submit"
                        class="px-8 py-2 bg-green-200 rounded-lg mt-4 transition-all duration-100
        ...
        <div>
            <h1
                class="text-2xl font-bold font-kanit italic tracking-wide  mt-12 border-l-8 border-gray-300
                px-6 py-2 mx-auto inline-block">
                Demain
            </h1>
