...
@section('section')
    ...
    @endif
    @if(session('errors'))
        <div class="mt-10 rounded-md bg-red-300  flex content-center w-2/3 mx-auto p-4" id="closer">
            <div class="flex">
                <div class="flex-shrink-0">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-green-800">{{ session('errors')->first('email') }}</p>
                </div>
            </div>
        </div>
    @endif
