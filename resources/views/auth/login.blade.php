...
@section('section')
    ...
    @if(session('errors'))
    <div class="mt-10 rounded-md bg-red-100 flex content-center w-3/12 mx-auto absolute z-1200 top-12 right-2 px-4 py-3" id="closer">
        <div class="flex">
            <div class="flex-shrink-0">
            ...
            <div class="ml-3">
                <p class="text-sm font-medium text-red-800">{{ session('errors')->first('email') }}</p>
            </div>
        </div>
    </div>
    @endif
